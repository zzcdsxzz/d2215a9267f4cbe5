...
# Split data set
X_train, X_test, y1_train, y1_test, = train_test_split(X_scaled, y1, test_size=0.2, random_state=99)
...
grid_search = GridSearchCV(xgb_reg, param_grid, cv=4, scoring='r2', n_jobs=12)
