...
# Split data set
X_train, X_test, y1_train, y1_test, = train_test_split(X_scaled, y1, test_size=0.2, random_state=1)

# Define parameter grid
param_grid = {
    'n_estimators': [5, 7, 10, 30, 50, 100],
...
# Define parameter grid
nn_reg = RandomForestRegressor(random_state=1)
